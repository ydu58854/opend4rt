...
#!/usr/bin/env bash
set -euo pipefail
export CUDA_VISIBLE_DEVICES=0,1,2,3 TORCH_DISTRIBUTED_DEBUG=DETAIL NCCL_DEBUG=INFO TORCH_NCCL_ASYNC_ERROR_HANDLING=1
...
tensorboard.logdir=runs/pointodyssey
